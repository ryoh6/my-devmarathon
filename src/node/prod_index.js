...
const pool = new Pool({
  user: process.env.DB_USER, // PostgreSQLのユーザー名に置き換えてください
  host: "localhost",
  database: process.env.DB_NAME, // PostgreSQLのデータベース名に置き換えてください
  password: process.env.DB_PASS, // PostgreSQLのパスワードに置き換えてください
  port: 5432,
});
